        ...
        <div className={`relative flex min-h-0 flex-1 flex-col overflow-hidden ${showPresetsBrowser ? "opacity-50" : ""}`}>
          ...
          {editorMode ? (
            <div
              ...
              className="min-h-0 flex-1 overflow-hidden border-l border-t border-l-orange-500 border-t-orange-500 shadow-[inset_2px_0_0_0_#f97316,inset_0_2px_0_0_#f97316]"
            />
          ) : (
            settingsPanels
          )}
