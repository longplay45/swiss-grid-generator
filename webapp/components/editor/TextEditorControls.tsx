...
import { FONT_OPTIONS } from "@/lib/config/fonts"
import {
  AlignLeft,
  AlignRight,
  Bold,
...
import type { BlockEditorState, BlockEditorStyleOption } from "@/components/dialogs/BlockEditorDialog"
...
export type TextEditorControlsProps<StyleKey extends string> = {
...
export function TextEditorControls<StyleKey extends string>({
  editorState,
  setEditorState,
  saveEditor,
  deleteEditorBlock,
  ...
  onColorSchemeChange,
  palette,
}: TextEditorControlsProps<StyleKey>) {
  ...
  }, [editorState.draftFxLeading, editorState.draftFxSize, editorState.target])
